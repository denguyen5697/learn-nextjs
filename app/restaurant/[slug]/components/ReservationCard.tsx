  ...
  return (
    <div className='fixed w-[15%] bg-white rounded p-3 shadow'>
      ...
      <div className='flex flex-col my-3'>
        ...
        <select name='' className='py-3 font-light bg-white border-b' id=''>
      ...
      <div className='flex justify-between'>
        <div className='flex flex-col w-[48%]'>
          ...
          <input
            type='text'
            className='py-3 font-light bg-white border-b w-28'
          />
        </div>
        <div className='flex flex-col w-[48%]'>
          <label htmlFor=''>Time</label>
          <select name='' id='' className='py-3 font-light bg-white border-b'>
